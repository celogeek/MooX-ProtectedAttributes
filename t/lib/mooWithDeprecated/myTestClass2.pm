package t::lib::mooWithDeprecated::myTestClass2;
use Moo;
use MooX::ProtectedAttributes;
with 't::lib::mooWithDeprecated::myTestClassRole2';

protected_with_deprecated_has 'foo' => (is => 'rw'), unless => sub {$ENV{SKIP_WARNING}};
